	...
	<body>
		...
		<header class="header">
			<div class="codrops-links">
				<a class="codrops-icon codrops-icon--prev" href="https://in.bookmyshow.com/national-capital-region-ncr?gclid=EAIaIQobChMIr_Gd3fuA3AIVEBOPCh3c5wRNEAAYASAAEgLx4vD_BwE" title="Previous Demo"><span>Previous Demo</span></a>
				<a class="codrops-icon codrops-icon--drop" href="http://www.niitstudent.com/india/studentweb/index.aspx" title="Back to the article"><span>Back to the Codrops article</span></a>
			</div>
		...
		<div class="plan">
			...
			<ul class="legend">
				...
				<li class="legend__item legend__item--selected">Selected</li>
                        ...
                        <a class="action action--buy" href="Online Ticket.jsp" role="button">Buy Tickets</a>
		</div><!-- /plan -->
